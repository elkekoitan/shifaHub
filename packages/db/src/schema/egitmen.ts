...
export const egitmen = pgTable(
  "egitmen",
  {
    ...
    supervisingPhysicianName: varchar("supervising_physician_name", {
      length: 100,
    }),
    ...
    // Musaitlik
    defaultSessionDuration: varchar("default_session_duration", {
      length: 10,
    }).default("60"),
  ...
  (t) => [index("egitmen_user_id_idx").on(t.userId)],
);
