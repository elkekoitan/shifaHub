  ...
  return (
    <div>
      <div className="mb-7 flex flex-col items-center gap-3 text-center">
        <span className="flex size-12 items-center justify-center rounded-full bg-accent text-primary ring-1 ring-primary/15">
        ...
        <div>
          ...
          <p className="mt-1.5 text-sm text-text-2">Doğrulama uygulamandaki 6 haneli kodu gir.</p>
        </div>
      </div>
      ...
      <form onSubmit={onSubmit} className="space-y-4" noValidate>
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <KeyRound className={iconCls} aria-hidden />
            <Input
              id="mfa-code"
              inputMode="numeric"
          ...
          {code.length > 0 && !valid ? (
            <p className="text-xs text-destructive">6 haneli kodu eksiksiz girin.</p>
          ) : null}
        </div>
